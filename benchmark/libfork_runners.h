...
[[nodiscard]] BenchRow runLibforkFibFine(std::size_t participants, int n, int cutoff,
...
[[nodiscard]] BenchRow runLibforkStrassen(std::size_t participants, std::size_t n,
                                          const CyclesPerNanosecond &cal);

[[nodiscard]] BenchRow runLibforkCilksort(std::size_t participants, std::size_t n,
                                          const CyclesPerNanosecond &cal);

/// Recursive divide-and-conquer dgemm. Mirrors libfork's published bench
/// shape (`bench/source/matmul/libfork.cpp`).
[[nodiscard]] BenchRow runLibforkMatmulDac(std::size_t participants, std::size_t n,
                                           const CyclesPerNanosecond &cal);

/// Skynet 1M -- 10-way fanout, depth 6, sum 0..(10^6 - 1).
[[nodiscard]] BenchRow runLibforkSkynet(std::size_t participants, const CyclesPerNanosecond &cal);
