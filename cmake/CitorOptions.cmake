...
option(CITOR_BUILD_BENCHMARK "Build the comparative bench" ${CITOR_IS_TOP_LEVEL})
option(
    CITOR_BUILD_WITH_SANITIZER
    "Compile and link with -fsanitize=thread"
    OFF
)
...
option(CITOR_ENABLE_POOL_COUNTERS "Compile in pool-level diagnostic counters" OFF)
...
set(CITOR_WORKER_STACK_KIB "8192" CACHE STRING "Per-worker pthread stack size, KiB")
